...
class PetRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Pet $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Pet $entity, bool $flush = true): void
    {
    ...
    * @return Pet[]
    */
    public function searchByName($petname)
    {
        return $this->createQueryBuilder('pet')
            ->andWhere('pet.petname LIKE :name')
